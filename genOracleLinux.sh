...
SERVER_VERSION_FULL["5.5"]="5.5.58-${VERSION_DOCKERFILES}"
SERVER_VERSION_FULL["5.6"]="5.6.38-${VERSION_DOCKERFILES}"
SERVER_VERSION_FULL["5.7"]="5.7.20-${VERSION_DOCKERFILES}"
SERVER_VERSION_FULL["8.0"]="8.0.3-dmr-${VERSION_DOCKERFILES}"
